    ...
    def apply(self, f, context):
        ...
        def _f():
            ...
            if content_type == 'application/json':
                ...
                if data is None:
                    abort(400, 'Value \'image\' missing')
                try:
                    decoded_data = base64.b64decode(data, validate=True)
                except binascii.Error:
                    abort(415, 'base64 decode failed')
                ...
                try:
                    ...
                    abort(400, 'Form field \'image\' missing')
                except UnicodeError:
                    abort(400, '\'image\' not Unicode')
            ...
            try:
                ...
                abort(415, 'Image format not supported or image data corrupt')
